...
export default class GlobalDonorTemplate extends Component {

    renderDonorList(dataset, limit) {
        return dataset.slice(0,limit).map((donor, index) => {
            return (
            ...
            <div id="export1" class={`${style.exportWrapper} ${style.globalDonorsWrapper}`}>
                ...
                <section class={style.sectionWrapper}>
                    ...
                    <ul class={style.donorsList}>
                        {
                            this.renderDonorList(tabData.data.data,7)
                        }
                    </ul>
                </section>
            </div>
