...
export default class ThemesPage extends Component {
    ...
    componentDidMount() {
        this.props.fetchDonorSliderData(this.props.currentYear, this.props.sector_code);
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.currentYear != this.props.currentYear) {
            this.props.fetchDonorSliderData(nextProps.currentYear, this.props.sector_code)
                    ...
                    {   <div>
                            <div style={{ paddingTop: '9px', display: this.state.listSelected ? 'block' : 'none'  }}>
                                    <BootTable count={totalDataSize}
                                        ...
                                        theme={this.props.sector_code}
                                        data={projectListArr}
                                        ourFocus={this.props.sector_code}
                                         />
                            </div>
                            <div class={style.mapContainer} style={{ position:'relative',display: this.state.listSelected ? 'none' : 'block' }}>
                                {isMapDataNonEmpty ?
                                    <Map
                                        sector={this.props.sector_code}
                                        mapData={mapData} 
                                        yearSelected={this.props.endYear}
                                        />:<PreLoader/>
                                }
                                ...
                                <section class={style.theme_slider_wrapper} >
                                    ...
                                    <div>
                                    {
                                        ...
                                        <div class={style.outcome_chart_wrapper}>
                                            ...
                                            chartWidth={560}
                                            chartHeight={400} 
                                            chart_id={'signatureSolution_chart'} />
                                        </div>
                                        :    <NoDataTemplate />
                                    }
                                    </div>
